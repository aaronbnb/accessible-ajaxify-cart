...
var ajaxifyShopify = (function(module, $) {
  ...
  init = function (options) {
    ...
    // Be Accessible - find all focusable children, for use within the modal
    ...
    // Be Accessible - save a reference to the current element in focus
  ...
  adjustCart = function () {
    ...
    qtyAdjust.on('click', function() {
      var el = $(this),
          id = el.data('id'),
          line = el.closest('[data-line]').data('line'),
    ...
    function updateQuantity(line, qty) {
      ...
      if (!settings.useCartTemplate) {
        var row = $('.ajaxcart__row[data-id="' + line + '"]').addClass('is-loading');
      } else {
        var row = $('.cart__row[data-id="' + line + '"]').addClass('is-loading');
      }
      ...
      setTimeout(function() {
        BOLD.helpers.changeItem(line, qty) 
